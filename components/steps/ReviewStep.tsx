  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-gray-600 mb-6">
        Please review all the information you've provided. You can go back to any section to make changes.
      </p>
        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {state.personalInfo.address}, {state.personalInfo.city}, {state.personalInfo.state} {state.personalInfo.zipCode}
              </dd>
            </div>
          </dl>
        </div>
        ...
        <div className="border-t border-gray-200">
          <dl>
            ...
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {state.emergencyContact.relation}
              </dd>
            </div>
          </dl>
        </div>
        ...
        <div className="border-t border-gray-200">
          <dl>
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {state.employmentDetails.startDate}
              </dd>
            </div>
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {state.employmentDetails.position}
              </dd>
            </div>
          </dl>
        </div>
      ...
      {/* Banking and Tax information would be similar sections */}
